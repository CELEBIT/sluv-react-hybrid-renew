...
const Marketing = () => {
  return (
    <PageContainer>
      ...
      <ContentContainer>
        <MainText>마케팅 활용 및 광고성 정보 수신 동의</MainText>
        <ContentParagraphWrap>
          <p>귀하는 개인(신용)정보의 선택적인 수집∙이용, 제공에 대한 동의를 거부할 수 있습니다. </p>
          <p>
            다만, 동의하지 않을 경우 관련 편의제공(이벤트 안내, 공지사항, 할인행사)안내 등 이용
            목적에 따른 혜택에 제한이 있을 수 있습니다.
          </p>
          <p>그 밖에 계약과 관련된 불이익은 없습니다.</p>
          <p>
          ...
          <p>
            ...
            사은·판촉행사 등의 마케팅 활동, 시장조사 및 상품·서비스 개발연구 등을 목적으로 수집·이용
          </p>
          ...
          <p>동의일로부터 회원 탈퇴 혹은 마케팅 동의 해제 시까지 보유·이용</p>
