...
const Privacy = () => {
  return (
    <PageContainer>
      <HeaderWrapper>
        <Header title='개인정보 처리방침' isModalHeader={false} hasArrow={true}></Header>
      </HeaderWrapper>
      <ContentContainer>
        <MainText>스럽 개인정보 처리방침</MainText>
        <ContentParagraphWrap>
          <p>
            &lt;스럽&gt;은(는) 「개인정보 보호법」 제30조에 따라 정부주체의 개인정보를 보호하고 이와
          ...
          <p>
            &lt;스럽&gt;은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는
          ...
          <p>&nbsp;</p>
          <p className='title'>제2조(개인정보의 처리 및 보유 기간)</p>
          <p>
            ① &lt;스럽&gt;은(는) 법령에 따른 개인정보 보유&middot;이용기간 또는 정보주체로부터
            개인정보를 수집 시에 동의받은 개인정보 보유&middot;이용기간 내에서 개인정보를
            처리&middot;보유합니다.
          </p>
          <p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
          <p className='title'>제3조(개인정보의 제3자 제공)</p>
          <p>
            ① &lt;스럽&gt;은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만
          ...
          <p className='title'>제4조(개인정보처리 위탁)</p>
          <p>
            ① &lt;스럽&gt;은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를
            위탁하고 있습니다.
          </p>
          <p>1. &lt;현재 해당사항없음&gt;</p>
          <p>위탁받는 자 (수탁자) :</p>
          ...
          <p>위탁기간 :</p>
          <p>
            ② &lt;스럽&gt;은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적
          ...
          <p className='title'>제5조(정보주체와 법정대리인의 권리&middot;의무 및 그 행사방법)</p>
          <p>
            ① 정보주체는 &lt;스럽&gt;에 대해 언제든지 개인정보
            열람&middot;정정&middot;삭제&middot;처리정지 요구 등의 권리를 행사할 수 있습니다.
          </p>
          <p>
            ② 제1항에 따른 권리 행사는 &lt;스럽&gt;에 대해 「개인정보 보호법」 시행령 제41조제1항에
            따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 스럽은(는) 이에 대해 지체
            없이 조치하겠습니다.
          </p>
          <p>
            ③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여
            하실 수 있습니다.이 경우 &ldquo;개인정보 처리 방법에 관한 고시(제2020-7호)&rdquo; 별지
          ...
          <p>
            ⑥ &lt;스럽&gt; 정보주체 권리에 따른 열람의 요구, 정정&middot;삭제의 요구, 처리정지의
          ...
          <p className='title'>제6조(처리하는 개인정보의 항목 작성)</p>
          ...
          <p className='title'>제7조(개인정보의 파기)</p>
          <p>
            ① &lt;스럽&gt;은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
          ...
          <p>1. 파기절차</p>
          <p>
            &lt;스럽&gt;은(는) 파기 사유가 발생한 개인정보를 선정하고, 스럽의 개인정보 보호책임자의
            승인을 받아 개인정보를 파기합니다.
          </p>
          <p>2. 파기방법</p>
          ...
          <p className='title'>제8조(개인정보의 안전성 확보 조치)</p>
          <p>
            &lt;스럽&gt;은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
          </p>
          <p>1. 정기적인 자체 감사 실시</p>
          <p>
          ...
          <p>&nbsp;</p>
          <p className='title'>
            제9조(개인정보 자동 수집 장치의 설치&bull;운영 및 거부에 관한 사항)
          </p>
          <p>
            &lt;스럽&gt;은(는) 개개인에게 개인화되고 맞춤화된 서비스를 제공하기 위해 이용자의 정보를
          ...
          <p>&nbsp;</p>
          <p className='title'>제10조 (개인정보 보호책임자)</p>
          <p>
            ① &lt;스럽&gt;은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와
          ...
          <p>
            ② 정보주체께서는 &lt;스럽&gt;의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
            보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
            문의하실 수 있습니다. 스럽은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
            것입니다.
          </p>
          <p>&nbsp;</p>
          <p className='title'>제11조(개인정보 열람청구)</p>
          <p>
            정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
            있습니다.
          </p>
          <p>
            &lt;스럽&gt;은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
          </p>
